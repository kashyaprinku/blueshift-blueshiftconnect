...
class SyncEditButton extends Field 
{
    protected $_template = 'Blueshift_Blueshiftconnect::system/config/synceditbutton.phtml';
    /**
    * Checkbox constructor.
    * @param \Magento\Backend\Block\Template\Context $context
    * @param array $data
    */
    public function __construct(BlueshiftConfig $blueshiftConfig , Context $context , array $data = []) {
    ...
    */
    ...
    public function getButtonHtml()
    {
        ...
        )->setData([  'id' => 'sync_edit_btn_id','label' => __('Edit'), ] );
