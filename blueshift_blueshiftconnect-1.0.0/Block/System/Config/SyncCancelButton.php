...
class SyncCancelButton extends Field 
{
    protected $_template = 'Blueshift_Blueshiftconnect::system/config/synccancelbutton.phtml';
    /**
    ...
    public function getButtonHtml()
    {
        ...
        )->setData([  'id' => 'sync_cencal_id' , 'label' => __('Cancel'), ] );
